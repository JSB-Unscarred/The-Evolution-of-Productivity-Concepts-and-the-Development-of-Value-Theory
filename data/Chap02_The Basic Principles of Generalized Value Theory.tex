...
令$q_{ij}$表示生产者$i$在耗费单位劳动所生产产品$j$的使用价值量，也就是生产者$i$的绝对生产力；$t_{ij}$表示生产者$i$在生产单位使用价值的产品$j$所必需要耗费的劳动量（用劳动时间来衡量\cite[51]{ZhongGongZhongYangMaKeSiEnGeSiLieNingSiDaLinZhuZuoBianYiJuMaKeSiEnGeSiWenJiDi5Juan2009}），则有：
\begin{equation}
